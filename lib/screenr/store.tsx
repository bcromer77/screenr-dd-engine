...
export default function ExportPage() {
  ...
  const { getVariables, createExport } = useScreenR()
    ...
    try {
      ...
      if (format === "pdf") {
        ...
        const exportVars = vars
          ...
          .filter(Boolean) as Array<{ label: string; value: string; origin: string }>
        ...
        // Create audit log entry and export record
        createExport(dealId, "Analyst")
      } else {
        // XLSX stub - can be implemented later if needed
        // Optionally create export record here too
      }
    } catch (e) {
